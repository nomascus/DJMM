...
#open fasta file (should come from cDNA) and create dictionaries to count aa and nt
import sys
...
#save figure as PDF
fig.savefig('PCA_DNA2music.pdf', bbox_inches='tight')
